...
import utility.GetYesterdayDate;
...
public class ExtractSearchKeyWords {
	...
	public static void extractManyDayLogs(String databaseName, String collectionName) {
		MongoCollection<Document> logsCollection = MongodbConn.getMongoCollection(databaseName, collectionName);
	...
	public static void extractOneDay(String dateStr, String databaseName, String collectionName) {
		...
		ArrayList<Document> searchWordsDocuments = new ArrayList<Document>();
		...
		// "logs" & "searchLogs"
		ClassifyLogs.storeMongodb(databaseName, "searchLogs", searchWordsDocuments);
	}
}
