 ...
 */
public class GenerateRecResults {
	/**
	 * test    模拟生成推荐结果
	 * */
	public static void main(String[] args) {
		...
		recRes1.setRes_id("00147584817501367cc3ae6c77a4b49a628571ac0cc6e27000");
		recRes1.setRes_type("news");
		recRes1.setUrl("http://ikcest.xjtu.edu.cn/info/1002/29560.htm");
		...
		recRes2.setRes_id("0014639682192079b9c1699be8044b0a30e2c150828f201000");
		recRes2.setRes_type("ebook");
		recRes2.setUrl("http://ebooks.spiedigitallibrary.org/book.aspx?bookid=58");
		...
		recRes3.setRes_id("001476715791812fba189de04204b05a72c495c03d5049e000");
		recRes3.setRes_type("uansr");
		recRes3.setUrl("https://www.scopus.com/inward/record.uri?eid=2-s2.0-84981516063&partnerID=40&md5=dbda71792f7556068a584da301bf7633");
		...
		recRes4.setRes_id("00146656739590072a264cd71544f969a73a398087cb085000");
		recRes4.setRes_type("conf");
		recRes4.setUrl("http://www.zingconferences.com/conferences/neurobiology-memory-c");
		...
		recRes5.setRes_id("0014762417923130e5b90fb66da4421b908a14a30014af4000");
		recRes5.setRes_type("patent");
		recRes5.setUrl("http://ikcest.xjtu.edu.cn/patent_n_content.jsp?urltype=tree.TreeTempUrl&wbtreeid=1214&patent_number=CN105288577-A");
	...
	static void complementResInfoStoreIntoMongo (String user_id, ArrayList<RecResource> recResources) {
		...
		MongoCollection<Document> mongoCollection = MongodbConn.getMongoCollection(databaseName, mongoCollectionName);
	...
	static News selectNewsInfo(Connection mysqlConn, RecResource recResult) throws SQLException {
		News news = new News();
	...
	static Ebook selectEbookInfo(Connection mysqlConn, RecResource recResult) throws SQLException {
		Ebook ebook = new Ebook();
	...
	static Paper selectPaperInfo(Connection mysqlConn, RecResource recResult) throws SQLException {
		Paper paper = new Paper();
	...
	static Conference selectConfInfo(Connection mysqlConn, RecResource recResult) throws SQLException {
		Conference conf = new Conference();
	...
	static Patent selectPatentInfo(Connection mysqlConn, RecResource recResult) throws SQLException {
		Patent patent = new Patent();
	...
	static void storeRecResourceIntoMongo(RecResource recResource, String user_id, MongoCollection mongoCollection) {
		...
		System.out.println("Successfully insert one RecResource into recResult!");
	}
}